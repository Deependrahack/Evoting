...
//$modltifolder = new admin_category('modevotingfolder', 'Evoting test');
//$ADMIN->add('modsettingevoting', $modltifolder);
//$temp = new admin_externalpage('evoting/logurl', 'E-voting Report', new moodle_url('/mod/evoting/report.php'));
//$ADMIN->add('modsettingevoting', $temp);
